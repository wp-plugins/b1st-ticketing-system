...
{
?>
       <div class="on_off <?php if($userdet->online_status==1) { ?> online <?php } if($userdet->online_status==0) { ?> offline <?php } ?>"></div><?php echo $userdet->username;?> <?php if($userdet->privilege_group_id==1) { echo "(SA)"; } ?>
